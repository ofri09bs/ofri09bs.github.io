...
* **Introduction to ROP:** As modern systems implement protections like NX/DEP (Non-Executable stack), simple shellcode injection isn't always possible. I started researching **Return-Oriented Programming (ROP)**. The core concept is fascinating: instead of injecting new code, we hijack the execution flow to chain together small snippets of existing executable code ("gadgets") that end in a `ret` instruction.
